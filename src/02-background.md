...
tune the model’s parameters) using a small amount of labeled data.^[Lukas Ruff et al. (2019),
"Deep Semi-Supervised Anomaly Detection" , [arXiv:1906.02694](https://arxiv.org/abs/1906.02694).]  
...
Given the importance of the anomaly detection task, multiple approaches haveR
...
areas: clustering, nearest neighbor, classification, and statistical. For a detailed survey of existing techniques, see ^[ Varun Chandola et al. (2009), "Anomaly Detection, A Survey" , _ACM Computing Surveys_ 41(3), [https://dl.acm.org/doi/10.1145/1541880.1541882](https://dl.acm.org/doi/10.1145/1541880.1541882).]). 
